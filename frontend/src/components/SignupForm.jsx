...
const SignupForm = () => {
  ...
  return (
    <div className='bg-gray-700 min-h-full py-8 grid place-items-center'>
      <form className='min-w-[50vh] max-w-[80vh] p-8 text-white grid items-center bg-gray-700 shadow-md rounded-md'>
        {loading ? (
          <Loader />
        ) : (
          <>
            ...
            <button className='bg-primary text-white px-4 py-2 rounded-md font-medium hover:bg-primary-dark' onClick={handleSubmit}>Submit</button>
